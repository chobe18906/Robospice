package com.octo.android.robospice.test;
...
import com.octo.android.robospice.test.core.SpiceTestService;
import com.octo.android.robospice.exception.RequestCancelledException;
import com.octo.android.robospice.persistence.DurationInMillis;
import com.octo.android.robospice.persistence.exception.CacheLoadingException;
import com.octo.android.robospice.persistence.exception.SpiceException;
import com.octo.android.robospice.test.request.CachedSpiceRequest;
import com.octo.android.robospice.test.request.SpiceRequest;
import com.octo.android.robospice.test.request.listener.RequestProgress;
import com.octo.android.robospice.test.request.listener.RequestStatus;
import com.octo.android.robospice.test.stub.PendingRequestListenerWithProgressStub;
import com.octo.android.robospice.test.stub.RequestListenerStub;
import com.octo.android.robospice.test.stub.RequestListenerWithProgressHistoryStub;
import com.octo.android.robospice.test.stub.RequestListenerWithProgressStub;
import com.octo.android.robospice.test.stub.SpiceRequestFailingStub;
import com.octo.android.robospice.test.stub.SpiceRequestStub;
import com.octo.android.robospice.test.stub.SpiceRequestSucceedingStub;
...
public class SpiceManagerTest extends AndroidTestCase {
    ...
    public void test_putInCache_should_put_some_data_in_cache() throws InterruptedException, CacheLoadingException, ExecutionException {
        ...
        assertTrue(requestListenerStub.isExecutedInUIThread());
        assertTrue(requestListenerStub.isSuccessful());
        Assert.assertEquals(TEST_RETURNED_DATA3, spiceManager.getDataFromCache(TEST_CLASS3, TEST_CACHE_KEY).get());
    }
    ...
    public void test_2_spice_managers_should_filter_spice_service_listener_events_for_their_own_requests_when_requests_are_added() throws InterruptedException {
        ...
        // test
        Assert.assertEquals(0, spiceManager.getRequestToLaunchCount());
        assertTrue(spiceManager.getPendingRequestCount() <= 1);
        Assert.assertEquals(0, spiceManager2.getRequestToLaunchCount());
